pro spa_realtime
  ...
  while 1 do begin
    ...
    if fileX55 then begin
      dualsps_plot,fileX55,'X55',win=1,xpos=150, ypos=300,xsize=600,ysize=300,inst='X55 Spectrum',/realtime
      dualsps_plot,fileX55,'SPS1',win=2,xpos=150, ypos=625,xsize=600,ysize=300,inst='XRS-C SPS Quad',/realtime
    endif else begin
